...
public class TTSUtils implements InitListener, SynthesizerListener, com.iflytek.cloud.SynthesizerListener {
    ...
    // 初始化合成对象
    public void init() {
        mTts = SpeechSynthesizer.createSynthesizer(JgApplication.context, this);
        // 清空参数
